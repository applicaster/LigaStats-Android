...
import com.applicaster.liga.statsscreenplugin.OptaStatsActivity.Companion.MATCH_ID
import com.applicaster.liga.statsscreenplugin.OptaStatsActivity.Companion.PUSH
import com.applicaster.liga.statsscreenplugin.OptaStatsActivity.Companion.TRUE
...
import com.applicaster.liga.statsscreenplugin.screens.matchdetails.adapter.PlayerGoalAdapter
import com.applicaster.liga.statsscreenplugin.screens.matchdetails.adapter.PlayerPosition
import com.applicaster.liga.statsscreenplugin.screens.matchdetails.adapter.PlayerPositionAdapter
import com.applicaster.liga.statsscreenplugin.screens.matchdetails.adapter.PlayerTeamAdapter
...
class MatchDetailsFragment : HeartbeatFragment(), MatchDetailsView {
    ...
    private fun setUpFormationFromLineUp(lineUpContestant: MatchModel.LineUp, line1: RecyclerView, line2: RecyclerView,
                                         line3: RecyclerView, line4: RecyclerView, line5: RecyclerView, isHomeTeam: Boolean) {
